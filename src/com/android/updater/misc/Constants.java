...
public final class Constants {
    ...
    static final String PROP_DEVICE = "ro.product.system.device";
    static final String PROP_BUILD_VERSION = "ro.system.build.version.release";
    static final String PROP_VERSION_CODE = "ro.product.system.name";
    static final String OTA_URL = "https://ota.sbwml.net/AOSP-11/%s/%s";
    static final String DOWNLOAD_WEBPAGE_URL = "https://www.cooluc.com/aosp.html";
    public static final String DOWNLOAD_PATH = "/data/ota_package/";
    static final String EXPORT_PATH = "/sdcard/";
}
